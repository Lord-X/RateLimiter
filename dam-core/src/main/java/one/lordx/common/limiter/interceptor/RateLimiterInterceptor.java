...
import one.lordx.common.limiter.holder.LimiterMapper;
 ...
 *       &lt;mvc:interceptor&gt;
 * &lt;mvc:mapping path="/**"/&gt;
 * &lt;bean class="one.lordx.common.RateLimiterInterceptor"&gt;
...
public class RateLimiterInterceptor extends HandlerInterceptorAdapter {
    ...
    private LimiterMapper limiterMapper;
    ...
    public RateLimiterInterceptor(String packageNames, IResponseObject responseObject) throws ClassNotFoundException {
        ...
        this.limiterMapper = new LimiterMapper(framework.limiter());
    }

    @Override
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        RateLimiterHolder holder = limiterMapper.getHolder(request.getRequestURI());
        if (holder == null) {
            return true;
        }
